...
export default function AiInvoiceOcrPage() {
  ...
  const run = async () => {
    ...
    try {
      ...
      const r = await fetch('/api/gap-ai-cash_flow/ai-invoice-ocr', {
        method: 'POST',
  ...
  return (
    <div style={{ padding: 24, maxWidth: 900, margin: '0 auto' }}>
      <h1 style={{ fontSize: 24, fontWeight: 700, marginBottom: 8 }}>AI invoice OCR</h1>
