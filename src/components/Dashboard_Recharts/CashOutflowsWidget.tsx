...
const CashOutflowsWidget: React.FC<CashOutflowsWidgetProps> = ({ transactions }) => {
  ...
  console.log('[CashOutflowsWidget] totalOutflows:', totalOutflows);
  console.log('[CashOutflowsWidget] categoryArray:', categoryArray);
  console.log('[CashOutflowsWidget] monthlyTrends:', monthlyTrends);
  console.log('[CashOutflowsWidget] filteredTransactions:', filteredTransactions);
                ...
                <div className="ml-2">
                  ...
                  <p className="text-sm text-warning-700">
                    {categoryArray.length > 0 ? (
                        ...
                        <div className="text-gray-500">No expense data for this period.</div>
                      )}
                  </p>
                </div>
              </div>
