...
const CashRunwayWidget: React.FC<CashRunwayWidgetProps> = ({ transactions }) => {
  ...
  console.log('[CashRunwayWidget] currentBalance:', currentBalance);
  console.log('[CashRunwayWidget] burnRate:', burnRate);
  console.log('[CashRunwayWidget] runway:', runway);
  console.log('[CashRunwayWidget] projectedRunway:', projectedRunway);
  console.log('[CashRunwayWidget] transactions:', transactions);
          ...
          {projectedRunway !== runway && (
            <div className="mt-3 pt-3 border-t border-blue-200">
              <p className="text-sm text-blue-900">
                <span className="font-medium">Projected Runway:</span> 
                {/* Guarded Projected Runway */}
                <p>
              ...
              <div className="ml-3">
                ...
                <p className={`text-3xl font-bold text-${runwayColor}-900`}>
                  {Number.isFinite(runway) && runway > 0
                      ? `${runway.toFixed(1)} <span className="text-lg font-medium ml-1">months</span>`
            ...
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-xl font-bold text-gray-900">
                  {Number.isFinite(burnRate) && burnRate > 0
